...
$usuario = $_SESSION['usuario'] ?? 'Invitado'; // esto usa el operador de fusion null (??), es como un if/else cortito
?>
            ...
            <div class="contenedor-video">
                ...
                <div class="overlay-video">
                    <div class="contenido-hero">
                        ...
                        <!-- si el usuario esta logueado mostramos boton para ir a su perfil -->
                        <a href="perfil.php" class="boton-primario boton-animado">ir a mi perfil</a>
                        <?php else: ?>
                        <!-- si no esta logueado mostramos boton para registrarse -->
